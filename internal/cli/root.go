...
import (
	...
	"github.com/villawolf/supashift/internal/config"
	"github.com/villawolf/supashift/internal/integrations"
	"github.com/villawolf/supashift/internal/model"
	"github.com/villawolf/supashift/internal/runner"
	"github.com/villawolf/supashift/internal/tui"
	"github.com/villawolf/supashift/internal/vault"
)
...
func newAutoCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if set {
				fmt.Printf("eval \"$(supashift use %s)\"\n", profile)
				return nil
			}
