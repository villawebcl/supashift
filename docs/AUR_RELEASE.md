...
```bash
./scripts/update-aur-bin.sh 0.1.0 your-github-user supashift "Maintainer Name" "maintainer@example.com"
```
...
cd supashift-bin
cp /path/to/supashift/packaging/aur/supashift-bin/PKGBUILD .
cp /path/to/supashift/packaging/aur/supashift-bin/.SRCINFO .
cp /path/to/supashift/LICENSE .
